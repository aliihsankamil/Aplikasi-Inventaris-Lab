        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="/dashboard/kategori">Data Kategori</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Pages Collapse Menu -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#Dataruangan"
                    aria-expanded="true" aria-controls="Dataruangan">
                    <i class="fas fa-fw fa-folder"></i>
                    <span>Ruang Management</span>
                </a>
                <div id="Dataruangan" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="{{ url('img/inventaris.jpg') }}" alt="...">
                <p class="text-center mb-2"><strong>Inventaris Barang</strong>
                <br> Ali Ihsan Kamil, Bonita Puspa Nagari, Elfi Rosdianty, Hamimah Nurhidayah</p>
            </div>
